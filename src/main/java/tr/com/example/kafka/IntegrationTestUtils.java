...
class IntegrationTestUtils {
     ...
     */
    static <K, V> List<V> readValues(final String topic, final Properties consumerConfig, final int maxMessages) {
     ...
     */
    static <K, V> List<KeyValue<K, V>> readKeyValues(final String topic, final Properties consumerConfig) {
     ...
     * @return The KeyValue elements retrieved via the consumer
     */
    static <K, V> List<KeyValue<K, V>> readKeyValues(final String topic, final Properties consumerConfig, final int maxMessages) {
     ...
     */
    static <K, V> void produceKeyValuesWithTimestampsSynchronously(
            final String topic,
     ...
     * @param <V>            Value type of the data records
     */
    static <K, V> void produceKeyValuesSynchronously(
            final String topic,
    ...
    static <V> void produceValuesSynchronously(
    ...
    static <K, V> List<KeyValue<K, V>> waitUntilMinKeyValueRecordsReceived(
     ...
     */
    static <K, V> List<KeyValue<K, V>> waitUntilMinKeyValueRecordsReceived(final Properties consumerConfig,
                                                                           final String topic,
                                                                           final int expectedNumRecords,
    ...
    static <V> List<V> waitUntilMinValuesRecordsReceived(final Properties consumerConfig,
                                                         final String topic,
     ...
     */
    static <K, V> void assertThatKeyValueStoreContains(final ReadOnlyKeyValueStore<K, V> store, final Map<K, V> expected)
            throws InterruptedException {
     ...
     * @param <V>      the store's value type
     */
    static <K, V> void assertThatOldestWindowContains(final ReadOnlyWindowStore<K, V> store, final Map<K, V> expected)
            throws InterruptedException {
